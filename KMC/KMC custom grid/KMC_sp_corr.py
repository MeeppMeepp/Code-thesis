from Definitions_sp_corr import *
...
while T >=263.15:
    ...
    with open("neighborssp.json", "r") as f:
    ...
    block_height, block_height_ref, neighbor, k_des, k_ads, k_diff, k_diff_hor, k_diff_ab, k_diff_below, k_x_y = create_arrays(
        grid_points)
    neighbor = initialise_neighbors(neighbor)
    k_des, k_ads, k_diff, k_diff_hor, k_diff_ab, k_diff_below, k_x_y, k_tot = create_rates(grid_points, neighbor,
                                                                                           block_height, alpha, beta,
                                                                                           k_des, k_ads, k_diff,
                                                                                           k_diff_hor, k_diff_ab,
                                                                                           k_diff_below, k_x_y,
                                                                                           lateral_neighbors)
    ...
    while time < time_end:
        ...
        block_height, neighbor, diff_pos = update_height_nb(rnd, xpos, k_diff_hor, k_diff_ab, k_diff_below,
                                                            block_height, neighbor, event, lateral_neighbors)
        ...
        k_des, k_ads, k_diff, k_diff_hor, k_diff_ab, k_x_y, k_tot = update_arrays(grid_points, neighbor, block_height,
                                                                                  alpha, beta, k_des, k_ads, k_diff,
                                                                                  k_diff_hor, k_diff_ab, k_diff_below,
                                                                                  k_x_y, lateral_neighbors)
        iterations += 1
